            ...
            <div id="primario">
                <div className='caixa'>
                    ...
                    <div className='caixa-conteudo destaque'>
                        <h3>Novas pesquisas</h3>
                        <img src="../../public/maisSaude.png" alt="" width='100%' />
                ...
                <div className='caixa'>
                    ...
                    <div className='caixa-conteudo'>
                        <ul id='lista-noticias'>
                            <li>
                                <Link to={'/'}>
                                    <img src="../../public/medicoP.jpg" alt="" width='80' />
                                    <h3>Novas pesquisas!</h3>
                            ...
                            <li>
                                <Link to={'/'}>
                                    <img src="../../public/doutor.jpg" alt="" width='80' />
                                    <h3>Novas pesquisas!</h3>
                                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                                </Link>
                            </li>
                            <li>
                                <Link to={'/'}>
                                    <img src="../../public/jovem.jpg" alt="" width='80' />
                                    <h3>Novas pesquisas!</h3>
                                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                                </Link>
                            </li>
                            <li>
                                <Link to={'/'}>
                                    <img src="../../public/atleta.jpg" alt="" width='80' />
                                    <h3>Novas pesquisas!</h3>
                                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                                </Link>
                            </li>
